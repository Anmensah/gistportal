...
let menuItems = document.querySelectorAll('nav li'); // Select all <li> elements
...
const apiKey = "ed550cf263a74984abe9b1c66873635d";
...
const fetchData = async (category, pageSize) => {
    try {
        ...
        return response.articles; // Return response.articles instead of data.articles
    } catch (error) {
...
fetchData('technology', 5).then(add_technews); // Corrected function name
